 ...
 * alpha < 1f. Making any of these return a fully-opaque color WILL FAIL THE
 * BUILD. Do not do it — raise it with Kemar first.
 */
internal object AirdropChrome {
    /** Translucency of the header/footer surfaces (rgba(...,0.70) per Figma). */
    const val SCRIM_ALPHA = 0.70f
