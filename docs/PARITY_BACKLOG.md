...
> The list below was catalogued at `08e36e2`. Since then **26 items are fixed or verified on-device** and locked by regression proof. Do not redo them.
