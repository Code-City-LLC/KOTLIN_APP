...
**Maintainer:** BlueDeer (Swift/Figma/device verification lane, ORC fleet) · **Updated:** 2026-07-06 (rev 9 — P6 Notifications R1 restore + C5 per-type icons FIXED & verified (3e0aaf9/cd3e497); invoice-lock tolerance-hardened; Restricted Items legal-info added)
